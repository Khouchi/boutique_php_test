...
$paypal_id='khouchi-1991@outlook.fr'; // Business email ID
?>
<?php
...
<body>
	...
	<div id="header">
		...
		<label>M34CrossFit</label>
			...
			<ul>
				<li><a href="function/logout.php"><i class="icon-off icon-white"></i>Se déconnecter</a></li>
	...
	<div id="profile" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				<div class="modal-header">
					...
					<form method="post">
						<center>
							<table>
								<tr>
									<td class="profile">Nom:</td><td class="profile"><?php echo $fetch['firstname'];?>&nbsp;<?php echo $fetch['mi'];?>&nbsp;<?php echo $fetch['lastname'];?></td>
								</tr>
								<tr>
									<td class="profile">Adresse:</td><td class="profile"><?php echo $fetch['address'];?></td>
								</tr>
								<tr>
									<td class="profile">apt,suite,nom de l'entreprise:</td><td class="profile"><?php echo $fetch['country'];?></td>
								</tr>
								<tr>
									<td class="profile">Code postal:</td><td class="profile"><?php echo $fetch['zipcode'];?></td>
								</tr>
								<tr>
									<td class="profile">Numéro du téléphone:</td><td class="profile"><?php echo $fetch['mobile'];?></td>
								</tr>
				...
				<div class="modal-footer">
					...
					<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Fermé
					</button>
				</div>
					</form>
			</div>
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br/>
						<br/>
						<button class="btn btn-lg" >Espèces</button>
					</center>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Fermé</button>
					</form>
			</div>
		</div>
