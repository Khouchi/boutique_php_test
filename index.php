...
<body>
	<div id="header">
		...
		<label>M34CrossFit</label>
			<ul>
				<li><a href="#signup"   data-toggle="modal">S'inscrire'</a></li>
		...
		<div id="signup" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
					<h3 id="myModalLabel">inscrire-vous ici...</h3>
				</div>
					<div class="modal-body">
					<center>
					<form method="post">
						...
						<input type="text" name="address" placeholder="Adresse" style="width:430px;"required>
						<input type="text" name="country" placeholder="apt,suite,nom de l'entreprise" >
						<input type="text" name="zipcode" placeholder="Code Postal" required maxlength="5">
				...
				<div class="modal-footer">
					...
					<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">ferme</button>
				</div>
					</form>
			</div>
	<br>
<div id="container">
	...
	<ul>
				...
				<li><a href="product.php"><i class="icon-th-list"></i>Produits</a>
				<li><a href="aboutus.php"><i class="icon-bookmark"></i>A Propos</a></li>
				<li><a href="contactus.php"><i class="icon-inbox"></i>Contact</a></li>
				<li><a href="privacy.php"><i class="icon-info-sign"></i>Politique de Protection</a></li>
	...
	<div id="content">
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h2><legend>Éléments</legend></h2></center>
			<br />
